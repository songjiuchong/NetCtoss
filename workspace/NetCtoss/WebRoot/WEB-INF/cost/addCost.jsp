...
<html xmlns="http://www.w3.org/1999/xhtml">
            ...
            $(function(){
            	$("#costName").blur(function(){
            		...
            		if(name == null||name==""){
            			...
            			//发送异步请求给AddCostValidateAction,返回是否验证通过;
            			$.post("addCostValidate.action",
            			{"name":name},
            			function(data){
            				if(data){
            					//返回值为true,则校验通过;
    ...
    <body>
        ...
        <div id="main">            
            ...
            <form action="addCost" method="post" id="addCostForm" class="main_form">
                <div class="text_info clearfix"><span>资费名称：</span></div>
                <div class="input_info">
                    <input type="text" name="cost.name" id="costName" class="width300" value=""/>
