    	...
    	<script type="text/javascript" language="javascript">
			...
			function saveUserInfo() { 
           		if ($("#rmbUser").attr("checked")){ 
					...
					var passWord = $("#userPassword").val(); 
					$.cookie('remembered','true',{expires:7,path:'/NetCtoss/login/'}); //存储一个根路径为'/NetCtoss/login/',带7天期限的 cookie;
					$.cookie("adminCode",userName,{expires:7,path:'/NetCtoss/login/'});
					$.cookie("password",passWord,{expires:7,path:'/NetCtoss/login/'});
				} 
				else { 
